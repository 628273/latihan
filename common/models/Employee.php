...
class Employee extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['salary', 'tunjangan', 'tunjangan_jabatan', 'position_id'], 'integer'],
            ...
            [['band'], 'string', 'max' => 1],
            [['kota', 'admins', 'medical_admin', 'area', 'status', 'no_ktp', 'suku', 'golongan_darah', 'no_npwp', 'nama_ibu'], 'string', 'max' => 45],
    ...
    {
        return $this->hasMany(Keluarga::className(), ['employee_person_id' => 'person_id']);
    }
}
